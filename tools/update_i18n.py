...
"""
Python 3 script for managing Ads Valuetranslations in Chrome JSON format

It is intended for:
- downloading AdBlock language files from Crowdin
- downloading Ads Valuelanguage files from Crowdin
...
def buildArchive(project):
    if project == "adblock":
        ...
        printBold("Building Ads Valuelanguage archive...")
...
# Download language archives for AdBlock and Ads Valueprojects
...
def downloadAndExtractArchive(project):
    if project == "adblock":
        ...
        print(" - Downloading Ads Valuelanguage archive...", end="")
...
# Merge temporary Ads Valuestrings into temporary AdBlock strings
def mergeStrings():
    printBold("Merging Ads Valueand AdBlock language files...")
