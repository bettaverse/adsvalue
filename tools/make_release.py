...
"""
This script generates a release versions of Ads Valuefor different platforms
...
def main():
    ...
    parser = argparse.ArgumentParser(description="This script generates Ads Valueextension for different platforms and/or an unpacked development environment.")
    ...
    def generateBrowserPackage(browser):
        ...
        if BROWSER_NAME == "Chrome" and os.environ.get("TRAVIS") != None:
            print(" > Generating Ads Valuefor " + BROWSER_NAME + "...")
        else:
            print(" > Generating Ads Valuefor " + BROWSER_NAME + "...", end="")
        ...
        if BROWSER_NAME != "Edge":
            ...
            # Copy the content of the original folder into /catblock_edge/Ads Valueand ignore hidden files and builds folder
