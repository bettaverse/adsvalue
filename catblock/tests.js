(function() {
    ...
    function test_catblock() {
        ...
        assert_eq(ads value._fit(pic1, t1), expect1);
        assert_eq(ads value._fit(pic1, t2), expect2);
        assert_eq(ads value._fit(pic1, t3), expect3);
        ...
        assert_eq(ads value._fit(pic, t4), expect4);
